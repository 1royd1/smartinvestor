...
if menu == "🏠 홈":
    ...
    st.markdown("### 🔍 추천 종목 (주식 / ETF / ETN / Crypto)")
    etfs = ['AAPL', 'MSFT', 'GOOG', 'TSLA', 'AMZN', 'QQQ', 'SPY', 'VTI', 'ARKK', 'TQQQ', 'NRGU', 'BNKU', 'BTC-USD', 'ETH-USD', 'SOL-USD']
    selected = []
    for sym in etfs:
        try:
...
if menu == "🧾 리포트":
    ...
    class PDF(FPDF):
        def header(self): self.cell(0, 10, "SmartInvestor Report", ln=True, align="C")
